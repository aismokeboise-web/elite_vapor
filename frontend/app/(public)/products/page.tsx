...
export default function AllProductsPage() {
  ...
  return (
    <div className="flex flex-col bg-slate-100">
      <section className="w-full border-b border-slate-200 bg-gradient-to-r from-indigo-100 via-slate-50 to-sky-100 py-8 sm:py-10">
        <div className="mx-auto flex max-w-6xl flex-col items-center gap-3 px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="max-w-2xl text-sm text-slate-600 sm:text-base">
            Browse our complete range of devices, disposables, and accessories in one place.
          </p>
        </div>
      </section>
