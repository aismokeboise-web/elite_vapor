...
/* Set to your own GIF or image URL for a custom banner; leave unset to use the code-based animated banner. */
...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col">
      {/* Hero: code-based animated banner or custom GIF/image, with text + button above (z-10) */}
      <section className="relative min-h-[440px] w-full overflow-hidden bg-slate-900 md:min-h-[520px]">
        {/* Layer 1: Banner – animated gradient (default) or your GIF/image */}
        {BANNER_IMAGE ? (
          ...
          <div className="public-banner-animated absolute inset-0 z-0" />
        )}
        <div className="public-banner-shine z-0" aria-hidden />
        {/* Overlay gradient for readability */}
        <div
          className="absolute inset-0 z-[1] bg-gradient-to-t from-slate-900/95 via-slate-900/60 to-slate-900/30"
          aria-hidden
        />
        {/* Content above banner – modern overlay with z-10 */}
        <div className="relative z-10 mx-auto flex min-h-[440px] max-w-6xl flex-col justify-end px-4 pb-16 pt-32 sm:px-6 md:min-h-[520px] md:pb-24 md:pt-40 lg:px-8">
          <motion.h1
          ...
          <motion.p
            ...
            className="mt-3 max-w-xl text-lg text-slate-200 drop-shadow sm:text-xl"
          >
            Premium vaping products and accessories. Quality you can trust.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 16 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <Link
              href="/products"
              className="inline-flex items-center rounded-full bg-slate-100 px-7 py-3 text-sm font-semibold text-slate-900 shadow-lg transition hover:bg-white hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-slate-200 focus:ring-offset-2 focus:ring-offset-slate-900"
            >
              Browse all products
            ...
            <Link
              ...
              className="inline-flex items-center rounded-full border border-white/70 bg-white/10 px-7 py-3 text-sm font-medium text-white shadow-sm backdrop-blur transition hover:bg-white/20 focus:outline-none focus:ring-2 focus:ring-white/60 focus:ring-offset-2 focus:ring-offset-slate-900"
            >
              Best sellers
            </Link>
          </motion.div>
