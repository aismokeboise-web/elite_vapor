...
export default function ShopPage() {
  ...
  const fetchProducts = useCallback(() => {
    ...
    fetch(`${BACKEND}/api/products?${params}`)
  ...
  return (
    <div className="flex flex-col bg-slate-100">
      <section className="w-full border-b border-rose-300 bg-gradient-to-r from-rose-100 via-slate-50 to-amber-100 py-8 sm:py-10">
        <div className="mx-auto flex max-w-6xl flex-col items-center gap-3 px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="max-w-2xl text-sm text-slate-600 sm:text-base">
            Clearance, limited-time deals, best sellers, and new arrivals in one curated feed.
          </p>
        </div>
      </section>
